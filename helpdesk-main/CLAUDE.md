# ResolveNow AI - AI-Powered Ticket Management System

## Project Overview

See `project-scope.md` for full requirements and `implementation-plan.md` for phased task breakdown.
...
- **AI**: Groq via Vercel AI SDK (`@ai-sdk/groq`)
