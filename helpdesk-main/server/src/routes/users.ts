...
router.post("/", requireAuth, requireAdmin, async (req, res) => {
  ...
  await logAudit("USER_CREATE", req.user.id, `Created user ${email} with role agent`);
...
router.put("/:id", requireAuth, requireAdmin, async (req, res) => {
  ...
  await logAudit("USER_UPDATE", req.user.id, `Updated user ${id} (${email})`);
...
router.delete("/:id", requireAuth, requireAdmin, async (req, res) => {
  ...
  await logAudit("USER_DELETE", req.user.id, `Deactivated user ${id}`);
