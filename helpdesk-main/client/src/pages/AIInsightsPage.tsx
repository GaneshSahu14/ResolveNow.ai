...
export default function AIInsightsPage() {
  ...
  return (
    <PageTransition className="flex-1 overflow-y-auto p-8 md:p-12 w-full max-w-[1600px] mx-auto scrollbar-hide">
      ...
      >
      {/* Header */}
      <header className="mb-12 relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="col-span-1 md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass-panel p-8 rounded-2xl glow-card transition-all duration-300 relative overflow-hidden ai-glow bg-surface-container-lowest/40 hover:border-primary/30 group">
          ...
          <div className="glass-panel p-8 rounded-2xl glow-card transition-all duration-300 relative overflow-hidden bg-surface-container-lowest/40 hover:border-secondary/30 group">
          ...
          <div className="md:col-span-2 glass-card p-8 rounded-2xl min-h-[400px] flex flex-col">
        ...
        <div className="col-span-1 md:col-span-4 space-y-8 flex flex-col">
          ...
          {/* Escalation Risk */}
          <div className="glass-panel p-6 rounded-2xl glow-card transition-all duration-300 border border-error/20 hover:border-error/50 bg-surface-container-lowest/40">
          ...
          {/* Cost Savings */}
          <div className="glass-panel p-6 rounded-2xl glow-card transition-all duration-300 border border-tertiary/20 hover:border-tertiary/50 bg-surface-container-lowest/40">
            <div className="flex items-center space-x-3 mb-4">
          ...
          {/* Confidence Radar */}
          <div className="glass-panel p-6 rounded-2xl glow-card transition-all duration-300 border border-outline-variant/20 hover:border-primary/30 bg-surface-container-lowest/40 flex-1 flex flex-col">
             <div className="mb-4">
